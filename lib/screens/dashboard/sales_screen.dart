          ...
          PostModel.fromJson(value).status.contains("SUCCESS")
            ...
            setState(() {
              if (dealerListPodo != null) {
                dealerDataList = dealerListPodo.map<AlertWithUsers>((json) => AlertWithUsers.fromJson(json)).toList();
              }
            }),
    ...
    return Scaffold(
      body: dealerDataList!=null? ListView(
          ...
          children: List.generate(dealerDataList.length, (index) {
            return Center(child: dealerDataList[index]?.alert?.category=="Sale"?PostCard(choice: dealerDataList[index], item: dealerDataList[index]):Container());
