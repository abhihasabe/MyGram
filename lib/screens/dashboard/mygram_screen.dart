...
import 'package:mygram_app/screens/content_uplode_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: dealerDataList!=null? ListView(
          ...
          children: List.generate(dealerDataList.length, (index) {return Center(child: PostCard(choice: dealerDataList[index], item: dealerDataList[index]));
